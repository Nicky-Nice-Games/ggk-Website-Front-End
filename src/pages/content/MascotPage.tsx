...
const MascotPage = () => {
  return (
    <>
      ...
      <div className="flex flex-col min-h-[73vh] bg-size-[110%] bg-blend-multiply w-[100%] bg-size-[90%] md:bg-size-[80%] pt-5"
        style={{
          backgroundImage:
        ...
        <div className="flex flex-col-reverse md:flex-row md:justify-between">
          <p className="m-3 mx-[2rem] mb-[3rem] p-4 md:p-8 rounded-xl md:max-w-[50%] bg-gray-200 text-black text-body">
            ...
            Though Gizmo is quite timid, students find that Gizmo is very optimistic 
            and believes in a good future for games as a form of entertainment.
             Additionally, Gizmo carries a small box of trinkets and knickknacks to share!
          </p>
          <img
