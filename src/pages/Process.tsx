        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="pt-5">
            ...
            <ProcessDropdown
              value="about-project"
              trigger={
                <h1 className="text-header2 my-4"> About The Project</h1>
              }
              content={
                <div className="flex md:flex-row flex-col items-stretch">
                  <p className="text-body mb-4">
                    ...
                    Nicholas Buonarota. All students are split into 8 sub-teams
                    by their specialty:
                    <ul className="list-disc *:my-2 ml-5 my-4">
                      ...
                      <li>
                        ...
                        Assists other teams in various areas and ensures
                        progress doesn't slow down.
                      </li>
                      <li>
                        <b className="font-bold text-[#fb923c]">
                    ...
                    team meetings occur on-campus with all local members
                  ...
                  <div className="md:min-w-[400px] md:w-300 mb-7 md:mb-0 flex flex-col items-center">
                    ...
                    <ArrowButton
                      ...
                      className="font-semibold px-10 py-3 mt-4"
                    />
                  </div>
                </div>
              }
          ...
          <ProcessDropdown
            ...
            content={
              <div className="flex md:flex-row flex-col items-stretch">
                <p className="text-body text-white mr-8 mb-4">
                  ...
                  cooler tones you see in other kart games. Our tracks take you
                  to playful, cartoon versions of RIT landmarks like the SHED
                  and Global Village, and racers are based on familiar IGM
                  student characters—skaters, dining workers, orientation
                  leaders, and so on. The UI emulates old‑school racing games,
                  keeping everything clear and focused on your racer.
                  Altogether, the design is meant to capture the unique,
            ...
            content={
              <>
                <p className="text-body">
                  ...
                  character production for a high-quality base cast with room
                  for future expansion. Character are also meant to have easily
                  identifiable heads, as those are what will be most prominently
                  seen by players in-game. The original plan for the roster was
                  to include multiple RIT mascots, but this caused complications
                  with requiring approval from third parties to include their
                  mascots. As a result, most of the characters are original
            ...
            content={
              <div className="pb-[1rem] flex md:flex-row flex-col items-stretch">
                ...
                <p className="text-body">
                  ...
                  game's functionality. Given the scope of their work, they
                  follow several practices to stay organized and efficient. To
                  keep the GitHub repo clean and avoid merge conflicts, GSP uses
                  feature branches and forks for development. All code pushed to
                  main goes through a pull request and approval process,
                  ensuring no broken code makes it into the daily builds. Daily
                  builds of the game are created to quickly catch and resolve
                  functionality issues, and to ensure there's always an updated
                  version ready for playtesting. The team regularly peer
                  programs, which helps with idea brainstorming, faster
                  debugging, and overall productivity. As GSP remote lead Logan
                  Larrondo said, “Peer programming helps brainstorm ideas, debug
                  faster, and is often more efficient than working alone.” To
                  stay on track, the team fills out daily Google Forms, logging
                  progress and helping with planning. When major bugs appear,
                  GSP tackles them together, through research, code reviews, or
                  simply joining a call to talk things out.
                </p>
              </div>
            }
          />
            ...
            content={
              <>
                <p className="mb-8 text-body">
                  ...
                  locations with original twists. With an initial plan of 4
                  tracks per cup and some difficulty guidelines from the
                  creative director, research into the location of basis and
                  difficulty level is conducted. Once complete, sketches of the
                  track layouts are created, then translated to a 3D model in
                  Blender, with environmental background details being added as
                  the finishing touch. In addition, track layouts are tweaked in
                  response to feedback from playtesters.
                </p>
                      ...
                      <div className="max-h-full overflow-y-auto">
                        ...
                        <div className="flex flex-col md:flex-row">
                          <div className="md:mr-10">
                            ...
                            <p className="text-body mb-[1rem]">
                              A track based on RIT's Quarter Mile, a long
                              pathway connecting the dorm buildings to the
                              academic buildings, was developed and tested
                              several times, but eventually cut from the track
                              roster. The layout's size and length made it
                              highly challenging to scale down to the level of a
                              track with 3 laps.
                            </p>
                          </div>
                          <div className="">
                        ...
                        <div>
                          ...
                          <ul className="list-disc ml-5 *:mb-2 text-body">
                            <li>
                              <b>The SHED:</b> An early drafted track based on
                              the Student Hall for Exploration and Development
                              (SHED). The track was never given a proper layout
                              and cut for similar reasons to the Quarter Mile.
                            </li>
                            <li>
                              <b>RIT Woods:</b> A track was modeled and
                              visualized based on the woods near Grace Watson
                              Hall to contrast with the urban visuals of the
                              other tracks. The design ended up not aligning
                              thematically or feeling recognizable as an RIT
